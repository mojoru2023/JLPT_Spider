...
def insertDB(content):
    ...
    try:
        cursor.executemany('insert into N2 (title,links) values (%s,%s)', content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
    except TypeError :
...
if __name__ == '__main__':
    ...
    # url = 'http://language.koolearn.com/jp/N2/beikao/'

    for num in range(1,37):
        url = 'http://language.koolearn.com/jp/N2/beikao/' + str(num)+ '.html'
